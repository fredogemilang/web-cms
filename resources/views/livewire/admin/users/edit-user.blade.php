<div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
    <div class="lg:col-span-8 space-y-8">
        <section
            ...
            <div class="mb-10">
                <h2 class="text-xl font-bold text-[#111827] dark:text-[#FCFCFC]">User Information
                </h2>
                <p class="text-sm text-[#6F767E] mt-1">Manage user's basic account details and identity.
                </p>
            </div>
            ...
            <div class="mt-8 space-y-1">
                ...
                <p class="text-xs text-[#6F767E] mt-2">Brief description for the user. Maximum 200
                    characters.</p>
            </div>
        ...
        <section
            ...
            <div class="mb-10">
                ...
                <p class="text-sm text-[#6F767E] mt-1">Assign roles to define user access levels.
                </p>
            </div>
            <div class="space-y-4">
                ...
                <label class="flex items-center p-4 rounded-2xl border border-gray-100 dark:border-[#272B30] hover:bg-gray-50 dark:hover:bg-[#272B30]/30 transition cursor-pointer group">
                    <input type="radio" wire:model.live="selectedRole" value="{{ $role->id }}" name="role_selection"
                        class="w-5 h-5 text-primary border-gray-300 focus:ring-primary dark:bg-[#0B0B0B] dark:border-[#272B30]">
                    <div class="ml-4">
                        <span class="block text-sm font-bold text-[#111827] dark:text-[#FCFCFC] group-hover:text-primary transition-colors">{{ $role->name }}</span>
        ...
        <section
            ...
            <div class="mb-10">
                ...
                <p class="text-sm text-[#6F767E] mt-1">Enhance account safety and access control.
                </p>
            </div>
            <div class="space-y-6">
                <div
