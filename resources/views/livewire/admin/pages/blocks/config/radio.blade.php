...
<div class="space-y-3">
    <div class="flex items-center justify-between">
        <label class="text-[10px] font-bold text-[#6F767E] uppercase tracking-wider">Radio Options</label>
    ...
    <div class="space-y-2">
        ...
        @if(empty($block['options']['choices']))
            <p class="text-xs text-[#6F767E] italic py-2">No options defined yet. Click "Add Option" to add radio choices.</p>
        @endif
    </div>
</div>
